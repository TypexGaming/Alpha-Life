...
{
	titleText[format["%1 a été saisi, vous avez reçus %2$ comme récompense.",_itemName,[(life_illegal_items select _illegal) select 1] call life_fnc_numberText],"PLAIN"];
...
if(_diff <= 0) exitWith {hint "Vous ne pouvez pas prendre cet objet, votre sac est plein."};
