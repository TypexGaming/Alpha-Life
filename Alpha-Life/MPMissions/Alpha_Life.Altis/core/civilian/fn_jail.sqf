...
titleText["Vous êtes en état d'arrestation, attendez de purger votre peine. Si vous faites une déco/reco votre temps sera réinitialisé!","PLAIN"];
hint "Pour avoir été en état d'arrestation vous avez perdu les permis suivant\n\nPermis de port d'armes\nLicence de Rebelle";
...
if(life_inv_alcoolcontre > 0) then {[false,"alcoolcontre",life_inv_alcoolcontre] call life_fnc_handleInv;};
