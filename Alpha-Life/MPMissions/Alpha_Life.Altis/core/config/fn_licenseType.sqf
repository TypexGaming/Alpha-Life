...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "arme": {_var = "license_civ_arme"};
            case "silver": {_var = "license_civ_silver"};
            case "vin": {_var = "license_civ_vin"};
            case "alcoolcontre": {_var = "license_civ_alcoolcontre"};
            case "cigarette": {_var = "license_civ_cigarette"};
            case "cigare": {_var = "license_civ_cigare"};
            case "depanneur": {_var = "license_civ_depan"};
			case "donator": {_var = "license_civ_donator"};
			case "uranium": {_var = "license_civ_uranium"}; // Add this
			case "uranium1": {_var = "license_civ_uranium"}; // Add this
			case "uranium2": {_var = "license_civ_uranium"}; // Add this
