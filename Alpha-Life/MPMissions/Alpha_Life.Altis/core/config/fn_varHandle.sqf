...
switch (_mode) do
{
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_arme": {"arme"};
			case "life_inv_armer": {"armer"};
            case "life_inv_raisin": {"raisin"};
            case "life_inv_vin": {"vin"};
            case "life_inv_pommedeterre": {"pommedeterre"};
            case "life_inv_alcoolcontre": {"alcoolcontre"};
