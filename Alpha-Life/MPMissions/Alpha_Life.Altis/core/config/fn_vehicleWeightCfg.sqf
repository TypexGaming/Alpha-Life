...
switch (_className) do
{
	...
	case "C_Boat_Civil_01_F": {425};
	case "C_Boat_Civil_01_police_F": {425};
	case "C_Boat_Civil_01_rescue_F": {425};
	...
	case "B_Heli_Light_01_armed_F":{10};
	case "O_Heli_Light_02_unarmed_F": {85};
	...
	case "O_Truck_03_covered_F": {475};
	case "O_Truck_03_device_F": {550};
	case "Land_CargoBox_V1_F": {5000};
	case "Box_IND_Grenades_F": {350};
	case "B_supplyCrate_F": {700};
	case "O_APC_Wheeled_02_rcws_F": {50};
	case "B_APC_Wheeled_01_cannon_F": {50};
	default {-1};
};
