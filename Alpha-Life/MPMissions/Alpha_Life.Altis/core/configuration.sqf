...
*****************************
*/
__CONST__(life_cop_ticket_promo,TRUE); //Should cops get a promo from paid tickets, set to false if you don't want
__CONST__(life_cop_ticket_percent, 25); //Cop ticket promo percentual from ticket value
...
__CONST__(life_impound_boat,3200);
__CONST__(life_impound_air,5500);
life_istazed = false;
...
switch (playerSide) do
{
	...
	case civilian: 
	{
		life_atmcash = 6000; //Starting Bank Money
...
[
    ...
    "life_inv_raisin",
    "life_inv_vin",
    "life_inv_pommedeterre",
    "life_inv_alcoolcontre",
    "life_inv_silverore",
    "life_inv_silverr",
    "life_inv_bois",
    "life_inv_charbon",
...
//Licenses [license var, civ/cop/med]
life_licenses =
[
	["license_cop_air","cop"],
	...
	["license_civ_arme","civ"],
    ["license_civ_silver","civ"],
    ["license_civ_vin","civ"],
    ["license_civ_alcoolcontre","civ"],
...
//[shortVar,reward]
life_illegal_items = [["heroinu",1200],["heroinp",2500],["cocaine",1500],["cocainep",3500],["marijuana",2000],["turtle",3000],["blastingcharge",10000],["boltcutter",500],["arme",1500],["armer",3700],["cigare",1300],["alcoolcontre",1300],["ipuranium",10000],["moonshine",9000],["bottledshine",11000],["mash",5000]];
...
[
	...
	["C_Offroad_01_F", 3500],
	["B_G_Offroad_01_F",4500],
	["C_SUV_01_F",7000],
	["C_Van_01_transport_F",9000],
	["C_Hatchback_01_sport_F",11000],
	["C_Van_01_fuel_F",4500],
	["I_Heli_Transport_02_F",170000],
	["C_Van_01_box_F",25000],
	["I_Truck_02_transport_F",17000],
	["I_Truck_02_covered_F",17000],
	["B_Truck_01_transport_F",32000],
	["B_Truck_01_covered_F",35000],
	["B_Truck_01_box_F", 45000],
	["O_MRAP_02_F",45000],
	...
	["O_APC_Wheeled_02_rcws_F",200000],
	["B_APC_Wheeled_01_cannon_F",200000]
];
