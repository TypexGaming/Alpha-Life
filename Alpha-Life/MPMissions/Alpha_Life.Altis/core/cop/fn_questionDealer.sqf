...
if(count _sellers == 0) exitWith {hint "Personne n'a vendu à ce dealer récemment."}; //No data.
...
hint parseText format["Les personnes suivantes ont vendu à ce dealer récemment.<br/><br/>%1",_names];
