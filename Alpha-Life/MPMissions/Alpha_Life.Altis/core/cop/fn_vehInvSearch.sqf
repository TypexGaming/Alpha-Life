...
if(_value > 0) then
{
	[[0,format["Un véhicule a été fouillé et a %1$ de drogues/contrebandes.",[_value] call life_fnc_numberText]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	life_atmcash = life_atmcash + _value;
	_vehicle setVariable["Trunk",[],true];
}
	else
{
	hint "Rien d'illégal dans ce véhicule.";
};