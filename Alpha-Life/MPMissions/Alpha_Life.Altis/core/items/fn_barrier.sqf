...
life_action_barrierDeploy = player addAction["Mettre la barrière",{if(!isNull life_barrier) then {detach life_barrier; life_barrier = ObjNull;}; player removeAction life_action_barrierDeploy; life_action_barrierDeploy = nil;},"",999,false,false,"",'!isNull life_barrier'];
...
life_action_barrierPickup = player addAction["Retirer la barrière",life_fnc_packUpBarrier,"",0,false,false,"",
