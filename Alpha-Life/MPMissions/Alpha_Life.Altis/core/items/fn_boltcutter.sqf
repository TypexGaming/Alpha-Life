...
[[[1,2],"!!!!! LES PORTES DE LA RESERVE FEDERALE SONT ATTAQUER !!!!!!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
[[_vault],"life_fnc_bankalarmsound",nil,true] spawn life_fnc_MP;
} else {
[[0,format["%1 a été vu en train de braquer une maison.",profileName]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
};
...
if((_building getVariable[format["bis_disabled_Door_%1",_door],0]) == 0) exitWith {hint "Cette porte est déjà déverrouillé!"};
life_action_inUse = true;

//Setup the progress bar
disableSerialization;
_title = "Découpe de la serrure";
