...
hint format["%1 vous a secouru et des frais de %2$ ont été prélevé de votre compte bancaire pour leurs services.",_medic,[(call life_revive_fee)] call life_fnc_numberText];
