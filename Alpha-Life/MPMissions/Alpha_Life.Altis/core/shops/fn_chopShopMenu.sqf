...
*/
if(life_action_inUse) exitWith {hint "Une action est déjà en cours de traitement ..."};
...
//Error check
if(count _nearVehicles == 0) exitWith {titleText["Il n'y a pas de véhicules à proximité a vendre.","PLAIN"];};
