...
"Rental Price: <t color='#8cff9b'>%1$</t><br/>Prix d'achat: <t color='#8cff9b'>%2$</t><br/>Vitesse Max: %3 km/h<br/>Cheveaux: %4<br/>Place assise: %5<br/>Capacité coffre: %6<br/>Capacité res.: %7<br/>Blindage: %8",
